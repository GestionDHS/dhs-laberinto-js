...
export class Juego {
  ...
  limpiarTablero() {
    ...
    let soloAleatoreos = this.listaDePersonajes.filter((personaje) => personaje.desapareceAlReiniciar == true);
    // console.log(soloAleatoreos);
		...
		this.listaDePersonajes = this.listaDePersonajes.filter((personaje) => personaje.desapareceAlReiniciar != true);
  ...
  generarPersonaje(personaje) {
		...
		if (clasePersonaje) {
			...
			unPersonaje.desapareceAlReiniciar = personaje.desapareceAlReiniciar || false;
		} else {
  ...
  crearPersonajes(conjuntosDePersonajes, reinicio = false) {
    if (!reinicio) {
      this.listaDeAleatoreos = conjuntosDePersonajes.filter(p => p.desapareceAlReiniciar == true)
    }
